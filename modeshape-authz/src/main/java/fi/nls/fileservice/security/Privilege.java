...
public class Privilege {
    ...
    public static final Privilege REMOVE_CHILD_NODES = new Privilege(
            "remove_child_nodes");
    public static final Privilege INDEX_WORKSPACE = new Privilege(
            "index_workspace");
    ...
    private static Privilege[] PRIVILEGES = new Privilege[] { Privilege.READ,
            ...
            Privilege.REMOVE_CHILD_NODES, Privilege.INDEX_WORKSPACE };
