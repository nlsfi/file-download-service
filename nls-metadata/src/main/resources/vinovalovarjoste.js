...
handlerRegistry.registerDatasetHandler((function () {
	...
	var fileIdentifier = '1f247c72-4487-4d20-9595-985560343066';
	var datasetName = 'vinovalovarjoste';
	var pattern = /\/tuotteet\/vinovalovarjoste\/(\w*)\/(\w*)\/(\w*)(?:\/[A-Z][0-9]{1,2}){0,2}\/(\w*)\w{4}.png$/i;
